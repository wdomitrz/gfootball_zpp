...
from gfootball.examples.env_composer import sample_composed_environment
...
flags.DEFINE_enum('policy', 'lstm', ['cnn', 'lstm', 'mlp', 'impala_cnn',
...
flags.DEFINE_integer('nminibatches', 4,
