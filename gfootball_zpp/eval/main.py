...
ABSTRACT_OPPONENTS = {
    ...
    'randomized_env': ZppEvalPlayerData('randomized_env', policy='multihead', sample='True', checkpoint='GS//less_randomized/less_then_partially_randomized_checkpoints_bots_4_heads_38/1/ckpt/0/ckpt-104'),
}
