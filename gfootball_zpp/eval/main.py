...
ABSTRACT_OPPONENTS = {
    ...
    'randomized_env': ZppEvalPlayerData('randomized_env', sample=True, policy='multihead', checkpoint='GS//less_randomized/less_then_partially_randomized_checkpoints_bots_4_heads_38/1/ckpt/0/ckpt-108'),
    'm_sp_in_ob_32_e61_p1': ZppEvalPlayerData('m_sp_in_ob_32_e61_p1', policy='multihead', sample=True, checkpoint='GS//m_sp/m_sp_in_ob_32_e61_p1/1/ckpt/0/ckpt-185'),
    'm_fsp_e71_64': ZppEvalPlayerData('m_fsp_e71_64', sample=True, policy='multihead', checkpoint='GS//m_fsp/m_fsp_e71_64/1/ckpt/0/ckpt-187'),
    'checkpoints_sp_c_e1': ZppEvalPlayerData('checkpoints_sp_c_e1', sample=True, policy='multihead', checkpoint='GS//zuzanna-seed/checkpoints_sp/checkpoints_sp_c_e1/1/ckpt/0/ckpt-358'),
    'partially_trained_randomized_diff': ZppEvalPlayerData('partially_trained_randomized_diff', sample=True, policy='multihead', checkpoint='GS//m_sp/m_sp_chin_e6/1/ckpt/0/ckpt-87'),
}
...
ABSTRACT_BOT_STAGES = [
    ...
    EvaluationStage('academy_5_vs_5_3v3_pass_and_shoot', BotEvalPlayerData(
        'academy_5_vs_5_3v3_pass_and_shoot', 0.05), GAMES * 2),
    EvaluationStage('academy_5_vs_5_4v0_with_keeper', BotEvalPlayerData(
        'academy_5_vs_5_4v0_with_keeper', 0.05), GAMES * 2),
    EvaluationStage('academy_5_vs_5_4v1', BotEvalPlayerData(
        'academy_5_vs_5_4v1', 0.05), GAMES * 2),
    EvaluationStage('academy_5_vs_5_4v2_random_0_70', BotEvalPlayerData(
        'academy_5_vs_5_4v2_random_0_70', 0.05), GAMES * 2),
    EvaluationStage('academy_5_vs_5_4v3_long_pass_and_shoot', BotEvalPlayerData(
        'academy_5_vs_5_4v3_long_pass_and_shoot', 0.05), GAMES * 2),
    EvaluationStage('academy_5_vs_5_4v3_random_0_65', BotEvalPlayerData(
        'academy_5_vs_5_4v3_random_0_65', 0.05), GAMES * 2),
    EvaluationStage('academy_5_vs_5_corner', BotEvalPlayerData(
        'academy_5_vs_5_corner', 0.05), GAMES * 2)
]
