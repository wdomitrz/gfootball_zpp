...
def build_scenario(builder):
    ...
    left_players = []
    left_players.append(get_player_position_from_gaussian(0.7, -0.05, sigma, sigma, e_PlayerRole_LB))
    left_players.append(get_player_position_from_gaussian(0.7, 0.05, sigma, sigma, e_PlayerRole_CB))
    ...
    (ball_x, ball_y, _) = get_player_position_from_gaussian(0.7, 0, sigma, sigma, None)
