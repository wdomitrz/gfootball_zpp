...
def build_scenario(builder):
    ...
    builder.SetBallPosition(0.77, -0.02)

    builder.SetTeam(Team.e_Left)
    builder.AddPlayer(-1.000000, 0.000000, e_PlayerRole_GK, controllable=False)
    builder.AddPlayer(0.750000,  0.020000, e_PlayerRole_RM)
    builder.AddPlayer(0.750000, -0.020000, e_PlayerRole_LM)
    builder.AddPlayer(0.800000, -0.100000, e_PlayerRole_CF)
    builder.AddPlayer(0.800000,  0.100000, e_PlayerRole_CF)
    builder.SetTeam(Team.e_Right)
    builder.AddPlayer(-1.000000, 0.000000, e_PlayerRole_GK, controllable=False)
    builder.AddPlayer(-0.870000, 0.000000, e_PlayerRole_RM)
