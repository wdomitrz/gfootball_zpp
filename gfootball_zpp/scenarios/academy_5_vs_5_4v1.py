...
def build_scenario(builder):
    ...
    left_players = []
    left_players.append(get_player_position_from_gaussian(0.7, 0.02, sigma, sigma, e_PlayerRole_RM))
    left_players.append(get_player_position_from_gaussian(0.7, -0.02, sigma, sigma, e_PlayerRole_CF))
    left_players.append(get_player_position_from_gaussian(0.8, 0.1, sigma, sigma, e_PlayerRole_LB))
    left_players.append(get_player_position_from_gaussian(0.8, -0.1, sigma, sigma, e_PlayerRole_CB))

    right_players = []
    right_players.append(get_player_position_from_gaussian(-0.9, 0, sigma, sigma, e_PlayerRole_RM))
