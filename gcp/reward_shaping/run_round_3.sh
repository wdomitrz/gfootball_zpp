...
../run.sh less_then_partially_bots_then_more_self_play_randomized_checkpoints_4_heads_66                less_randomized_then_self_play  checkpoints_self_play_4_heads.yaml          checkpoints_more_randomized_self_play_4_heads.json
../run.sh less_then_partially_bots_then_more_self_play_randomized_entropy_checkpoints_4_heads_67        less_randomized_then_self_play  checkpoints_self_play_4_heads_entropy.yaml  checkpoints_more_randomized_self_play_4_heads.json
